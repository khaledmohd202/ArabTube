        ...
        children: [
          ClipRRect(
            ...
            child: CachedNetworkImage(
              ...
              imageUrl: instance.profilePic!.isNotEmpty?instance.profilePic!:
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(instance.channelTitle!,style: TextStyle(
                ...
                RichText(
                  text: TextSpan(
                    ...
                    style: TextStyle(fontSize: MediaQuery.of(context).size.height*.014, color: const Color(0xffFF0000)),
                    children: <TextSpan>[
                      TextSpan(
                        text: 'Subscribers ',
                        style: TextStyle(
